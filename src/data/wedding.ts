...
export const wedding = {
  ...
  hero: { image: hero, alt: '버드나무 아래 잔디밭에서 활짝 웃는 신랑과 입을 가리고 웃는 신부', position: '50% 30%', og: heroOg as ImageMetadata | undefined, kakao: heroKakao as ImageMetadata | undefined },
